...
const Projects = () => {
    ...
    return (
        <motion.div
            ...
            <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting Spaces, Buiding Legacies-Explore Our Portfolio</p>
                    ...
                    {projectsData.map((project, index) => (
                        <div key={index} className='relative flex-shrink-0 w-full sm:w-1/4'>
                            ...
                            <div className='absolute left-0 right-0 bottom-5 justify-center'>
                                <div className='inline-block bg-white w-3/4 px-4 py2 shadow-md'>
